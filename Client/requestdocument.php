...
<h1 style="text-align: center;"> Select type of document</h1>


<div class="service-10 center">
    <div class="row">
        <!-- column  -->
        ...
        <a href="requestdocumentdetails.php?category=bid">
            <div class="wrap-service10-box text-center text-white ">
                <div class="display-4 mb-3 "><img src="assets/img/id.png" width="20%"></div>
                <small class="op-8"></small>
                <h5 class="text-white">Baranggay ID</h5>
</a>
        ...
        <a href="requestdocumentdetails.php?category=bc">
            ...
            <div class="display-4 mb-3"><img src="assets/img/deadline.png" width="20%"></div>
                <small class="op-8"></small>
                <h5 class="text-white">Barangay Clearance</h5>
</a>
            </div>
        </div>
         <!-- column  -->
        ...
        <a href="requestdocumentdetails.php?category=bp">
            <div class="wrap-service10-box text-white text-center">
            <div class="display-4 mb-3"><img src="assets/img/shop.png" width="20%"></div>
                <small class="op-8"></small>
                <h5 class="text-white">Business Permit</h5>
</a>
            </div>
        </div>
        <!-- column  -->
        ...
        <a href="requestdocumentdetails.php?category=bldg">
            ...
            <div class="display-4 mb-3"><img src="assets/img/deadline.png" width="20%"></div>
                <small class="op-8"></small>
                <h5 class="text-white">Building Permit</h5>
</a>
            </div>
        </div>
        <!-- column  -->
