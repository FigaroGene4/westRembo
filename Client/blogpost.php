...
<style>
  .jbt{
    background-image: url(img/westrembosignage.jpg);
...
<div class="p-4 shadow-4  jbt"    >
  <h2  style="color: white;">West Rembo Announcements</h2>
...
while( $rows = mysqli_fetch_assoc($resultset)){	
    ...
    echo "<h1>Subject: ".$rows['title']. "</h1>";
    echo "<h4>Date Posted: ".$cDate."</h4>";

    echo "<div class='h-100 d-flex align-items-center justify-content-center'><img src= '../admin/blogimage/".$rows["img"]."' class='image-responsives'/></div>";


    echo "<br> <p> ".$rows['content']."</p>";
