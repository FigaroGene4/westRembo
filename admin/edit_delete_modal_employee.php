    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<!--	<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="usernameEmployee" value="<?php echo $row['usernameEmployee']; ?>">
					</div></div>
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="contactNumberEmployee" value="<?php echo $row['contactNumberEmployee']; ?>">
					</div></div>
				-->
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<!--<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="addressEmployee" value="<?php echo $row['addressEmployee']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="birthdateEmployee" value="<?php echo $row['birthdateEmployee']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="genderEmployee" value="<?php echo $row['genderEmployee']; ?>">
					</div>
				</div>
                ...
                <div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="joinDateEmployee" value="<?php echo $row['joinDateEmployee']; ?>">
					</div>
				</div>
                ...
                <div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="serviceOffered" value="<?php echo $row['serviceOffered']; ?>">
					</div>
				</div>
