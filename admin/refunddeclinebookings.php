        ...
        <div class="main">
            ...
            <div class="container-fluid ">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link " href="refund.php">Refund Request</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="refunddeclinebookings.php">Refund Declined Bookings</a>
                    </li>
                        ...
                        <div class="height10">
                            ...
                            <table id="myTable" class="table text-center table-striped">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM table_book WHERE status = 'Declined' ";
